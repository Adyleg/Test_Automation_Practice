...
Register User Test automation
        ...
        Input Text                  xpath=//*[@id="form"]/div/div/div[1]/div/form/input[2]    addy9@xyz.com
        Input Text                  name=password  *Adylegtest1
        Click Button                xpath=//*[@id="form"]/div/div/div[1]/div/form/button
        Wait Until Page Contains     Logged in as    timeout=5s
        Click Element               xpath=//*[@id="header"]/div/div/div/div[2]/div/ul/li[5]/a
        Wait Until Page Contains    ACCOUNT DELETED!    timeout=5s
